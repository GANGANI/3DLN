...
def process_subdir(subdir):
    ...
    if second_dir != parent_directory:
        ...
        for file_name in os.listdir(subdir):
            ...
            output_file = f'state_v1/{second_dir}/google_broadcast_{second_dir}_{year}.jsonl.gz'
                    ...
                    with gzip.open(output_file, 'wt') as output_jsonl_file:
                        for line in input_jsonl_file:
                            ...
                            desired_rows = data.loc[
                                (data['website'] == list(json_obj.keys())[0]) &
                                (data['state-code'] == second_dir) &
                                (data['media-type'] == 'broadcast')]
...
subdirs = [os.path.join(parent_directory, d) for d in os.listdir(parent_directory) if
